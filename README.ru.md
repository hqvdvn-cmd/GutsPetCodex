# Питомец Guts для Codex

> Компактный анимированный спутник Guts для десктопного Codex: тёмная броня, суровый взгляд, Behelit и огромный Dragonslayer.

<p align="center">
  <img src="assets/preview.png" alt="Превью спрайт-листа анимированного питомца Guts" width="820">
</p>
...
- Готовый к установке кастомный питомец с именем `Guts`.
...
- Отдельные циклы с подбрасыванием Behelit и тренировкой с Dragonslayer на месте.
...
3. Откройте Codex, затем выберите **Settings → Pets** и питомца `Guts`.
...
Это неофициальный некоммерческий фанатский питомец. **Berserk**, Guts и Dragonslayer связаны с Кэнтаро Миурой и соответствующими правообладателями. Репозиторий не аффилирован и не одобрен ими.
